...
require "function" . DIRECTORY_SEPARATOR . "functions.php";
checkSession();
$path = "http://test/Formation/V3session/identification.php";
            ...
            <section class="login">
                ...
                <div class="login-body">
                    ...
                    <?php if (isset($success)) : ?>
                        <div class="alert alert-success"> <?= $success ?> <a class='login-support' href="<?= $path ?>">connection</a></div>
                    <?php endif ?>
