...
{
    return
        nav_item('/Exo/Grafikart/Exo(8)Dates/index.php', 'Acceuil', $linkclass) .
        nav_item('/Exo/Grafikart/Exo(8)Dates/contact.php', 'Contact', $linkclass) .
        nav_item('/Exo/Grafikart/Exo(8)Dates/jeu.php', 'jeu 1', $linkclass) .
        nav_item('/Exo/Grafikart/Exo(8)Dates/jeu2.php', 'jeu 2', $linkclass);
}
