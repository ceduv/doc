...
# Les getters sont des méthodes qui obtiennent
# et renvoient les propriétés internes d'un objet

# Les getters peuvent effectuer une action sur les données 
#   lors de l'obtention d'une propriété.
# Les getters peuvent renvoyer différentes valeurs à l'aide
#   de conditions.
